# Overview
+ Each folder is a Power BI project with the code used for the development of the solution.
+ The code is divided in the following way:

| Type | Html File |
| ------------- |:-------------:|
| DAX Measures      |  *Measures.html*   |
| M Code      | *M Queries.html*    |
| Relationships      | *Relationshps.html*    |

## Code
Each folder contains This repository contains the code used to develop the Power BI projects. The codes included are:  
...
## Business Scenarios
You can acess the Public Power BI to navigate between each project [here](https://github.com/oseliocandido/PowerBI-Code/blob/b40cfd6169b59a27e5897124dce681655d8079ff/Navigation%20Projects.png).


Here is possbile to navigate between each project
Cliking in one of them will redirect for the project where there is:
+ Business Scenario
+ Tasks
+ Actions
+ Result
and beyond that the the power bi solution when clicking on the picture.
...
## Code
This repository contains the code used to develop the Power BI projects. The codes included are:  
...
| Relationships      | *Relationships*    |
 ...
 These files were generated by PowerBI Helper.  
file 
![alt text](./Business_Cases.png)
